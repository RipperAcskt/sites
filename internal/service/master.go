...
func (m *Master) Start(ctx context.Context, userId, email string, price float64, time int) error {
	...
	err = m.masterProgram(email, time)
	if err != nil {
...
func (m *Master) masterProgram(email string, t int) error {
