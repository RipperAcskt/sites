...
func POST46(email string) error {
	urlString := "https://www.douglas.pl/jsapi/v2/users/newsletter/subscribe"

	data := fmt.Sprintf(`{"subscriptionId":"newsletter","email":"%s"}`, email)
